...
[
...
},
  {
...
},
	{
		...
		PostUrl: "https://charmingprogrammer.github.io/Manoarya/Manoarya%20All%20Post/How_to_make_modal_box_using_html_css_and_js.html",
...
for (let i = 0; i < OurData.length; i++) {
  //script for random behavior 
  const random = Math.floor(Math.random() * OurData.length);
  
 //script for show results on the DOM
  document.getElementById("output").insertAdjacentHTML('beforebegin',  `<h1>${OurData[random].Title}</h1>`);
}